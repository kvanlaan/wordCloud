 ...
 * items.
 * 
 * Operations are provided to insert, remove the item with the highest priority,
 * and get (but not remove) the item with the highest priority. The priority of
 * an item is determined by calling <tt>getPriority</tt> on that item; larger
